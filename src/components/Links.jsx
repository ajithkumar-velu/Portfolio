...
const Links = () => {
  return (
    <div className='flex gap-2 items-center m-auto xl:m-0' >
        <Button  btn={<a href={links.github} target='blank' > <img src={images.githubIcon} className='w-8' /></a>} cls="px-1 py-1 bg-btn-unique shadow-[-3px_-1px_3px_#152b2b,2px_1px_1px_#D6BD98] active:translate-x-[0.5%] active:translate-y-[0.5%] active:shadow-[-1px_-0.4px_3px_#152b2b] hover:scale-105" />
