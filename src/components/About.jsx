            ...
            <div className='flex gap-12 md:gap-16 lg:gap-24 flex-col mt-7 sm:mt-12 md:mt-16 xl:20 2xl:mt-24' >
                ...
                <div className='flex' >
                    <div className='2xl:w-3/5' >
                        <h1 className='text-c1 text-[clamp(2rem,3vw,1.5rem)] font-semibold mb-5 border-b-2 w-fit pb-2 border-c1' >💼 Who I Am</h1>
                        <div className='flex gap-2 flex-col text-black font-semibold bg-c1  px-10 py-14 rounded-3xl shadow-[-8px_-3px_8px_#152b2b,2px_1px_1px_#D6BD98] text-[clamp(1rem,1vw,1rem)] indent-16' >
